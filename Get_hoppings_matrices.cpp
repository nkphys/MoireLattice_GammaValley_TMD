...
string t0_hop_file="t0_BA_mat.txt";
...
if(dis_<Dis_max){
val_= Thop[2*atom1+orb1][2*atom2+orb2][i1_center][i2_center];
}
else{
val_=0.0;
}
...
string t0_hop2_file="tma2_BA_mat.txt";
ofstream t0_hop2(t0_hop2_file.c_str());
...
if(dis_<Dis_max){
val_= Thop[2*atom1+orb1][2*atom2+orb2][i1_center][i2_center+1];
}
else{
val_=0.0;
}
...
string t0_hop3_file="tpa1ma2_BA_mat.txt";
ofstream t0_hop3(t0_hop3_file.c_str());
...
if(dis_<Dis_max){
val_= Thop[2*atom1+orb1][2*atom2+orb2][i1_center-1][i2_center+1];
}
else{
val_=0.0;
}
...
string tpa1_AA_file="tpa1_AA_mat.txt";
ofstream tpa1_AA(tpa1_AA_file.c_str());
...
if(dis_<Dis_max){
val_= Thop[2*atom1+orb1][2*atom2+orb2][i1_center-1][i2_center];
}
else{
val_=0.0;
}
...
string tpa1_BB_file="tpa1_BB_mat.txt";
ofstream tpa1_BB(tpa1_BB_file.c_str());
...
string tma2_AA_file="tma2_AA_mat.txt";
ofstream tma2_AA(tma2_AA_file.c_str());
...
string tma2_BB_file="tma2_BB_mat.txt";
ofstream tma2_BB(tma2_BB_file.c_str());
...
string tpa1ma2_AA_file="tpa1ma2_AA_mat.txt";
ofstream tpa1ma2_AA(tpa1ma2_AA_file.c_str());
...
string tpa1ma2_BB_file="tpa1ma2_BB_mat.txt";
ofstream tpa1ma2_BB(tpa1ma2_BB_file.c_str());
...
string tpa1_BA_file="tpa1_BA_mat.txt";
ofstream tpa1_BA(tpa1_BA_file.c_str());
...
string tpa1_AB_file="tpa1_AB_mat.txt";
ofstream tpa1_AB(tpa1_AB_file.c_str());
...
string tpa1m2a2_BA_file="tpa1m2a2_BA_mat.txt";
ofstream tpa1m2a2_BA(tpa1m2a2_BA_file.c_str());
...
if(dis_<Dis_max){
val_= Thop[2*atom1+orb1][2*atom2+orb2][i1_center-1][i2_center+2];
}
else{
val_=0.0;
}
